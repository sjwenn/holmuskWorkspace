...
jsonConfig = jsonref.load(open('../config/modules/JWComorbid/figure1.json'))
logBase = config['logging']['logBase'] + '.modules.JWComorbid.figure1'
...
def main(logger, resultsDict):
    ...
    if jsonConfig["params"]["showGraphFlag"]:
        plt.show()
